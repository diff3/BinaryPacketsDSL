...
class WorldClientOpcodes(IntEnum):
    CMSG_BATTLE_PET_REQUEST_JOURNAL = 0x0A23 # fix from Pandaria
    CMSG_LOG_STREAMING_ERROR = 0x12B3 # Fix from Pandaria
...
class WorldServerOpcodes(IntEnum):
    ...
    SMSG_BATTLE_PAY_BOOST_ITEMS = 0x083B
    ...
    SMSG_BATTLE_PET_LOCATION_FINALIZE = 0x082E
    SMSG_BATTLE_PET_UPDATE_INIT = 0x0E1E
    ...
    SMSG_GM_TICKET_RESOLVE_RESPONSE = 0x1ABE
    ...
    SMSG_LFD_BOOT_PROPOSAL_UPDATE = 0x183A
    SMSG_LFD_DISABLED = 0x008E
    SMSG_LFD_JOIN_RESULT = 0x18E3
    SMSG_LFD_OFFER_CONTINUE = 0x1EAB
    SMSG_LFD_PARTY_INFO = 0x168E
    SMSG_LFD_PLAYER_INFO = 0x1861
    SMSG_LFD_PROPOSAL_UPDATE = 0x1E3B
    SMSG_LFD_QUEUE_STATUS = 0x1006
    SMSG_LFD_ROLE_CHECK_UPDATE = 0x12BB
    SMSG_LFD_TELEPORT_DENIED = 0x063B
    SMSG_LFD_UPDATE_STATUS = 0x0C2E
    ...
    SMSG_COMMENTATOR_MAP_INFO = 0x1CBE
    SMSG_SERVER_BUCK_DATA = 0x1142
    SMSG_VOICE_SESSION_ROSTER_UPDATE = 0x000E
    SMSG_EXPECTED_SPAM_RECORDS = 0x18C0
    SMSG_ACCOUNT_INFO_RESPONSE = 0x042F
    SMSG_SERVER_INFO_RESPONSE = 0x103A
    SMSG_DEBUG_AI_STATE = 0x0A2A
    SMSG_GM_CHARACTER_RESTORE_RESPONSE = 0x14E1
...
class WorldOpcodes:
    ...
    @staticmethod
    def getClientOpCodeName(cmd):
        return WorldOpcodes.getCodeName(WorldClientOpcodes, cmd)
